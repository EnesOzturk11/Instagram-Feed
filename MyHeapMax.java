// File: MaxBinaryHeap.java

public class MyHeapMax<AnyType extends Comparable<? super AnyType>> {
    ...
    public MyHeapMax(AnyType[] items) {
    ...
    // Delete the maximum element and return it
    ...
    // Percolate down method for maintaining max-heap property
